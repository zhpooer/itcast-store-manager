...
<BODY  bgColor=#ffffff leftMargin=0 background="<c:url value='/picture/bj1.gif'/>" topMargin=0>
		<s:form name="loginForm" action="login" cssStyle="margin-top:250px;">
			<DIV align=center>
											...
											<TD align="right" background="" height=13>
												<DIV align=left>
													<FONT color=#006633 size=2>用户名：</FONT><FONT color=#006633
														size=2>
														<s:textfield cssClass="tx" maxlength="15" size="15" name="name"></s:textfield> 
										...
										<TR>
											<TD Align=left background="" height=9>
												<DIV align=left>
													...
													<s:password cssClass="tx" maxlength="15" size="15" name="password" ></s:password>
												</DIV>
											</TD>
										</TR>
