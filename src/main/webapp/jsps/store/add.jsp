...
<body>
	...
	<table border="0" width="100%" cellpadding="0" cellspacing="0">
		<tr valign="top">
			<td rowspan="2"><s:form action="store_add.action" name="select">
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							<td>仓库名称：</td>
							<td><s:textfield cssClass="tx" name="name"></s:textfield></td>
						</tr>
						<tr>
							<td>仓库地址：</td>
							<td><s:textfield cssClass="tx" name="address"></s:textfield>
							</td>
						</tr>
						<tr>
							<td>库管员：</td>
							<td><s:textfield cssClass="tx" name="manager"></s:textfield>
							</td>
						</tr>
						<tr>
							<td colspan="2" align="center" style="padding-top: 10px;"><input
								class="tx" style="width: 120px; margin-right: 30px;"
								type="button" onclick="document.forms[0].submit();" value="确定">
